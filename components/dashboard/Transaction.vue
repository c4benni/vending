<template>
  <div class="card mx-6 shadow-md dark:shadow-none">
    ...
    >
      ...
      >
        <v-btn
          class="rounded-md px-5 h-[48px] bg-opacity-100 dark:bg-opacity-20 hover:bg-opacity-35 dark:hover:bg-opacity-35 gap-x-1 hover:bg-opacity-100 dark:hover:bg-opacity-80 hover:text-white hover:bg-opacity-35 dark:hover:bg-opacity-35 w-full text-md"
          :class="{
        ...
        >
          <v-icon
            size="28px"
            class="mr-2"
            v-text="isBuyer ? 'mdi-cash-plus' : 'mdi-cash-fast'"
          ></v-icon>
